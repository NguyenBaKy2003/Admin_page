...
const Sidebar = () => {
  const menuItems = [
    { label: "Home", icon: "🏠", path: "/main" },
    { label: "Job Seeker", icon: "🙎‍♂️", path: "/applicants" },
    ...
    { label: "Accounting", icon: "👤", path: "/profile" },
  ];
  ...
  return (
    <div className="w-64  bg-white shadow-md p-4 flex flex-col space-y-4 md:flex-col md:h-full md:space-y-2 max-md:flex  max-md:flex-row    max-md:items-center  max-md:w-auto max-md:justify-between   max-md:space-x-2 ">
      ...
      {/* Menu Items */}
      <div className="space-y-2  max-md:space-y-0 max-md:space-x-1 max-md:justify-between max-md:flex max-md:flex-row max-md:flex-wrap  max-md:w-screen ">
